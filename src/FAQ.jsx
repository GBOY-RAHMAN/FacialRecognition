...
export default function FAQ() {
 ...
 <div className='faq_dropper'>
  <section className='quote'> 
    <p className='questions_section'>How does facial recognition payment work? <span className='icons_readmore'> < AddIcon /></span> </p>
...
<section className='quote'> 
    <p className='questions_section'>Is my personal data secure? <span className='icons_readmore'> < AddIcon /></span>  </p>
...
<section className='quote'> 
    <p className='questions_section'>Can someone else use my photo to make a payment? <span className='icons_readmore'> < AddIcon /></span>  </p>
