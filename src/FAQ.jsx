...
<section className='quote'> 
    <p className='questions_section'>Is my personal data secure? <span className='icons_readmore' onClick={() => toggleAnswer(2)}>
              ...
              {openIndex === 1 && (<p className='questions_answer'>Yes, we prioritize your security and privacy. Our system encrypts all facial data, ensuring it is protected from unauthorized access. Additionally, your data is stored in compliance with industry standards, keeping your information safe and private.
